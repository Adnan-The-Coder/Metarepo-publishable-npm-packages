export const projects = [
  ...
  },
  {
    ...
    description:
      "Complete desktop assistant with graphical user interface built on Python and Tkinter GUI, with 25+ features inspired from Iron Man Jarvis.",
  ...
  },
  {
    ...
    description:
      "Qubit.mobi is the digital presence of Qubit, a dynamic platform offering a suite of services designed to enhance user engagement and growth. Their offerings include Quickie, a seamless e-commerce solution for convenient shopping; QuickGig, a freelancing hub connecting professionals with businesses; and Quantumania, a collaborative community for quantum enthusiasts to share ideas and resources. ",
    tech: ["Next.JS", "Node.js", "NeonDB", "prisma"],
    link: "https://qubit-bug-resolver-and-build.vercel.app/",
    image: "/assets/Qubit.png",
    githubLink:
      "https://github.com/Adnan-The-Coder/Qubit-Bug-resolver-and-build",
  },
  {
    title: "Time Management System",
    description:
      "Master your time with Toggle, a revolutionary time management system built using Python. With SQL database connectivity, it ensures seamless data handling and storage. Its intriguing Tkinter GUI offers an intuitive and engaging user experience.",
  ...
  },
  {
    ...
    description:
      "Navigate the skies with ease using COPS, a cutting-edge airways management system built using Python. Designed to revolutionize air traffic control, COPS brings efficiency and precision to your operations. Experience the future of airways management with COPS - Soaring above, beyond expectations.",
  ...
  },
  {
    ...
    description:
      "Developed using Python and OpenCV. Experience the magic of technology as it identifies faces with remarkable precision. Follow our video tutorial to build your own system. Let's explore the fascinating realm of face recognition together on this thrilling tech journey!🚀",
    tech: ["Python", "OpenCV"],
  ...
  },
  {
    ...
    description:
      "Demonstrates a foundational implementation of a serverless API using Cloudflare Workers. It leverages the Hono framework for routing, neonDB for database interactions, and Drizzle for database schema management. This setup exemplifies efficient API development within Cloudflare's serverless environment.",
  ...
  },
  {
    ...
    description:
      "High-performance API system built with HonoJS running on Cloudflare Workers with powerful database integration.",
